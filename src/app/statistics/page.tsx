...
export default function StatisticsPage() {
  const [progress, setProgress] = useState<ProgressStore>({ schemaVersion: 1, answers: [] });
  ...
  return (
    <div className="page">
      <header className="hero compact"><p className="eyebrow">АНАЛИТИКА</p><h1>Статистика</h1><p>Пока данные хранятся только в браузере. Схема БД для серверной синхронизации уже добавлена в проект.</p></header>
